    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="md:flex md:items-center md:justify-between mb-8">
            <div class="flex-1 min-w-0">
                ...
                <p class="mt-1 text-sm text-gray-500">Gestión central del sistema de reservas multitenant</p>
            </div>
                                ...
                                @foreach($recent_tenants as $tenant)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('admin.tenants.show', $tenant) }}" class="text-red-600 hover:text-red-900 mr-3">Ver</a>
                                            <a href="{{ route('admin.tenants.edit', $tenant) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Editar</a>
                                            <a href="https://{{ $tenant->domains->first()->domain ?? $tenant->id . '.book.aimadarek.com' }}/panel" 
                                               target="_blank" class="text-green-600 hover:text-green-900">Panel</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Estadísticas por Empresa</h3>
                    ...
                    @foreach($tenant_stats as $tenantId => $stats)
                        ...
                        <div class="border rounded-lg p-4">
                            ...
                            <div class="space-y-1 text-sm text-gray-600">
                                <div>Reservas: <span class="font-medium">{{ $stats['bookings'] }}</span></div>
                                <div>Servicios: <span class="font-medium">{{ $stats['services'] }}</span></div>
                                <div>Clientes: <span class="font-medium">{{ $stats['customers'] }}</span></div>
                            </div>
                        </div>
                    @endforeach
                </div>

    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="md:flex md:items-center md:justify-between mb-8">
            <div class="flex-1 min-w-0">
                ...
                <p class="mt-1 text-sm text-gray-500">Administra todos los usuarios del sistema multitenant</p>
            </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $users->where('active', true)->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Propietarios</dt>
                                <dd class="text-lg font-medium text-gray-900">{{ $users->where('role', 'owner')->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Personal</dt>
                                <dd class="text-lg font-medium text-gray-900">{{ $users->where('role', 'staff')->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 sm:px-6">
                ...
                <p class="mt-1 max-w-2xl text-sm text-gray-500">Todos los usuarios registrados en el sistema</p>
            </div>
                    ...
                    <div class="px-4 py-4 flex items-center justify-between">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="mt-1">
                                    ...
                                    <p class="text-sm text-gray-500">
                                        <span class="font-medium">{{ ucfirst($user->role) }}</span> en 
                                        <span class="font-medium">{{ $user->tenant->brand_name ?? 'Sin empresa' }}</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="flex items-center space-x-2">
                            ...
                            <form method="POST" action="{{ route('admin.users.toggle', $user) }}" class="inline">
                                ...
                                @method('PATCH')
                                <button type="submit" 
                                        class="inline-flex items-center px-3 py-1 border border-transparent text-xs font-medium rounded text-white {{ $user->active ? 'bg-red-600 hover:bg-red-700' : 'bg-green-600 hover:bg-green-700' }} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">

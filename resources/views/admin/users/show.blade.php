...
@section('title', __('admin.user_details.title') . ' - Super Admin')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-4 flex md:mt-0 md:ml-4 space-x-3">
                <a href="{{ route('admin.users.edit', $user) }}" 
                   class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                    ...
                    {{ __('admin.user_details.edit') }}
                </a>
                <form method="POST" action="{{ route('admin.users.destroy', $user) }}" class="inline" 
                      onsubmit="return confirm('{{ __('admin.user_details.delete_confirmation') }}')">
                    @csrf
                    @method('DELETE')
                    <button type="submit" 
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                    <div class="px-4 py-5 sm:px-6">
                        <h3 class="text-lg leading-6 font-medium text-gray-900">{{ __('admin.user_details.user_information') }}</h3>
                        <p class="mt-1 max-w-2xl text-sm text-gray-500">{{ __('admin.user_details.user_information_subtitle') }}</p>
                    </div>
                    <div class="border-t border-gray-200">
                        <dl>
                            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500">{{ __('admin.user_details.full_name') }}</dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $user->name }}</dd>
                            </div>
                            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500">{{ __('admin.user_details.email') }}</dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $user->email }}</dd>
                            </div>
                            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500">{{ __('admin.user_details.role') }}</dt>
                            ...
                            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500">{{ __('admin.user_details.company') }}</dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                    @if($user->tenant)
                                    ...
                                    @else
                                        <span class="text-gray-500">{{ __('admin.user_details.no_company_assigned') }}</span>
                                    @endif
                                </dd>
                            </div>
                            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500">{{ __('admin.user_details.status') }}</dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                    @if($user->active)
                            ...
                            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500">{{ __('admin.user_details.registration_date') }}</dt>
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $user->created_at->format('d/m/Y H:i') }}</dd>
                            </div>
                            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                <dt class="text-sm font-medium text-gray-500">{{ __('admin.user_details.last_update') }}</dt>
                ...
                <div class="mt-6 bg-white shadow overflow-hidden sm:rounded-lg">
                    <div class="px-4 py-5 sm:px-6">
                        <h3 class="text-lg leading-6 font-medium text-gray-900">{{ __('admin.user_details.booking_statistics') }}</h3>
                        <p class="mt-1 max-w-2xl text-sm text-gray-500">{{ __('admin.user_details.booking_statistics_subtitle') }}</p>
                    </div>
                    <div class="border-t border-gray-200">
                                    ...
                                    <div class="p-5">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-5 w-0 flex-1">
                                                <dl>
                                                    <dt class="text-sm font-medium text-gray-500 truncate">{{ __('admin.user_details.total_bookings') }}</dt>
                                ...
                                <div class="bg-gray-50 overflow-hidden shadow rounded-lg">
                                    <div class="p-5">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-5 w-0 flex-1">
                                                <dl>
                                                    <dt class="text-sm font-medium text-gray-500 truncate">{{ __('admin.user_details.today') }}</dt>
                                ...
                                <div class="bg-gray-50 overflow-hidden shadow rounded-lg">
                                    <div class="p-5">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-5 w-0 flex-1">
                                                <dl>
                                                    <dt class="text-sm font-medium text-gray-500 truncate">{{ __('admin.user_details.this_month') }}</dt>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                    <div class="px-4 py-5 sm:px-6">
                        <h3 class="text-lg leading-6 font-medium text-gray-900">{{ __('admin.user_details.actions') }}</h3>
                    </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <form method="POST" action="{{ route('admin.users.toggle', $user) }}">
                                ...
                                <button type="submit" 
                                    ...
                                    {{ $user->active ? __('admin.user_details.deactivate_user') : __('admin.user_details.activate_user') }}
                                </button>
                            </form>
                            ...
                            <a href="{{ route('admin.users.edit', $user) }}" 
                               class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                ...
                                {{ __('admin.user_details.edit_user') }}
                            </a>
                            ...
                            <a href="{{ route('admin.tenants.show', $user->tenant) }}" 
                               class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                ...
                                {{ __('admin.user_details.view_company') }}
                            </a>
                            @endif
                        </div>
                    </div>

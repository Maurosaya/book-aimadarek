...
@section('title', __('panel.bookings.edit'))
...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <ol class="flex items-center space-x-4">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('panel.bookings.show', $booking) }}" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-4 text-sm font-medium text-gray-500">{{ __('panel.common.edit') }}</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h2 class="mt-2 text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">
                    {{ __('panel.bookings.edit') }} - {{ $booking->customer->name }}
                </h2>
            </div>
        </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <form action="{{ route('panel.bookings.update', $booking) }}" method="POST" class="space-y-6 p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date" 
                               id="date" 
                               name="date" 
                               value="{{ old('date', $booking->start_at->format('Y-m-d')) }}"
                               required
                    ...
                    <div>
                        ...
                        <input type="time" 
                               id="time" 
                               name="time" 
                               value="{{ old('time', $booking->start_at->format('H:i')) }}"
                               required
                ...
                <input type="hidden" id="start_at" name="start_at" value="{{ old('start_at', $booking->start_at->format('Y-m-d H:i:s')) }}">
                ...
                <div>
                    <label for="status" class="block text-sm font-medium text-gray-700">
                        {{ __('panel.bookings.status') }} <span class="text-red-500">*</span>
                    </label>
                    <select id="status" 
                            name="status" 
                            required
                ...
                <div>
                    ...
                    <textarea id="notes" 
                              ...
                              placeholder="{{ __('panel.bookings.notes_placeholder') }}">{{ old('notes', $booking->notes) }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                    ...
                    <button type="submit" 
                        ...
                        {{ __('panel.bookings.update_booking') }}
                    </button>
                </div>
            </form>
        </div>

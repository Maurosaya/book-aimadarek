...
@section('title', __('panel.customers.create'))
...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <ol class="flex items-center space-x-4">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-4 text-sm font-medium text-gray-500">{{ __('panel.customers.create') }}</span>
                            </div>
                        </li>
                    </ol>
                </nav>
        ...
        <div class="bg-white shadow rounded-lg">
            <form action="{{ route('panel.customers.store') }}" method="POST" class="space-y-6 p-6">
                @csrf
                ...
                <div>
                    ...
                    <textarea id="notes" 
                              ...
                              placeholder="{{ __('panel.customers.notes_placeholder') }}">{{ old('notes') }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
